...
namespace TeslaRentalBackend.Migrations
{
    ...
    public partial class Changeseeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Vehicles",
                columns: new[] { "Id", "ImageUrl", "Mileage", "Model", "RentalPricePerDay" },
                values: new object[,]
                {
                    { new Guid("102b566b-ba1f-404c-b2df-e2cde39ade09"), "https://storage.carsmile.pl/uploads/2021/12/thumb_tesla_model_y.jpg", 12742f, 3, 350 },
                    { new Guid("2902b665-1190-4c70-9915-b9c2d7680450"), "https://img.chceauto.pl/tesla/model-x/tesla-model-x-suv-4038-41865_head.jpg", 12742f, 2, 300 },
                    { new Guid("d28888e9-2ba9-473a-a40f-e38cb54f9b35"), "https://storage.carsmile.pl/uploads/2021/10/thumb_tesla_sedan_31.jpg", 12742f, 1, 100 },
                    { new Guid("da2fd609-d754-4feb-8acd-c4f9ff13ba96"), "https://imagazine.pl/wp-content/uploads/2018/04/tesla-p100d.gif-hero.jpg", 12742f, 0, 250 }
                });
        }
